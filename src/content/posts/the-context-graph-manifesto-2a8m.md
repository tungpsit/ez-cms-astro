...
author: "Daniel Davis"
publishDate: 2025-12-31T21:45:00Z
featuredImage: "https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F2rw4k6ef3q3d91puyfvc.png"
category: "ai"
tags: ["ai", "programming", "opensource", "rag"]
draft: false
---

When [Mark Adams](https://x.com/cybermaggedon) and I ([Daniel Davis](https://x.com/TrustSpooky)) began working on what has become [TrustGraph](https://trustgraph.ai) over 2 years ago, we knew that graph structures would be instrumental in realizing the potential of AI technology, specifically LLMs. 
...
Context Engineering has always felt like a better fit to me, but it just hasn’t seemed to gain traction, until perhaps now? My attention was grabbed by my friend [Kirk Marple](https://x.com/KirkMarple)’s recent post, [The Context Layer AI Agents Actually Need](https://x.com/KirkMarple/status/2003944353342149021?), which was written in response to a post [Jaya Gupta](https://x.com/JayaGup10) and [Ashu Garg](https://x.com/ashugarg) of [Foundation Capital](https://foundationcapital.com/) that you might have read \- [AI’s trillion-dollar opportunity: Context graphs](https://foundationcapital.com/context-graphs-ais-trillion-dollar-opportunity/).

## **So... What is a Context Graph?**

Considering that we've been working on this very problem for a bit and TrustGraph has been [open source](https://github.com/trustgraph-ai/trustgraph) for nearly eighteen months, I feel qualified to offer a definition. Put simply, a context graph is a triples-representation of data that is optimized for usage with AI. That seems simple enough, right? That's what I thought when I started on the knowledge graph journey years ago as well...
...
Perhaps the biggest promoter of the term has been [Philip Rathle](https://x.com/prathle) from [Neo4j](https://neo4j.com), which offers the best-known graph database system for storing knowledge graphs. But here's where the confusion starts: Is a knowledge graph something you store, or is it how you store something? It's not just a knowledge graph—it's also a graph database. That distinction matters, but the boundaries are blurry.
...
As the internet grew in scale during the 1990s and 2000s, technologists began asking: how can autonomous systems exchange information with each other? Sound familiar? That question is foundational to modern interoperability challenges like [MCP](https://x.com/MCP_Community) and A2A—except those approaches treat it as if it's new, when in fact the semantic web community was thinking about this in the 1990s. I’ve personally worked with interoperable networking “protocols” in the aerospace industry that have their origins in the 1960s and are still in use today. 

[RDF](https://www.w3.org/TR/rdf-schema/) (the Resource Description Framework) adds structure to the triple concept by introducing classes, types, ranges, and strict syntax rules. The semantic web aimed to make knowledge representation mainstream by providing a standard framework that anyone could use. What many find odd about RDF is its use of URIs (Uniform Resource Identifiers)—often in the form of URLs. Why use web addresses as identifiers? The vision was interoperability: having globally unique identifiers ensured that two systems using the same URI would be referring to the same entity. Do the URLs themselves matter? No. That's a fair source of confusion.

RDF supports multiple serialization formats. RDF/XML follows XML structure but is an absolute eye-sore for humans. N-Triples is just a list of triples with required URIs for subjects and predicates—simpler, but still painful to read. For those who like JSON, there's JSON-LD. The most human-readable format is Turtle, which is elegant but syntactically sensitive with its indentation and whitespace requirements.

RDF is incredibly mature and robust. However, learning it independently is nearly impossible — the very definition of tribal knowledge. Without Mark Adams, co-founder of TrustGraph, writing [RDF guides](https://docs.trustgraph.ai/guides/knowledge-graphs) specifically for me, I would never have figured it out. Accurate RDF tutorials are hard to find, and many online articles are either wrong or skewed by singular perspectives.
...
As for standards: RDF developed as a modular, layered set of standards—competing ideas were tested, and the best ones emerged through real-world usage. Property graphs lack a formal standard, though [Cypher](https://opencypher.org/) (from Neo4j) became a de facto standard through widespread adoption. Other property graphs implemented it with variants. Very recently, this real-world usage influenced the development of an ISO standard, [GQL](https://www.iso.org/standard/76120.html). Unlike the modular RDF ecosystem, Cypher and GQL function more like single standards without the layered development that has been so productive in RDF's evolution.

## **Ontologies**

There's been considerable talk about ontologies recently. We launched [custom ontology features in TrustGraph](https://www.reddit.com/r/KnowledgeGraph/comments/1p54i8e/ontologydriven_ai/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button), and some have even used the term "OntologyRAG." But what exactly is an ontology?
...
OWL (Web Ontology Language) is one of the most common ontologies—it's an extension of RDF designed for building structured taxonomies. [SKOS](https://www.w3.org/TR/skos-reference/) (Simple Knowledge Organization System) is another interesting ontology that focuses more on concepts than OWL but never achieved widespread adoption. [Schema.org](http://Schema.org) is perhaps the best known ontology—it's a direct extension of the semantic web that attempts to create a granular taxonomy for all types of information featured on websites.
...
As I discussed earlier this year on the [How AI Is Built](https://www.youtube.com/@howaiisbuilt) podcast ([Temporal RAG: Embracing Time for Smarter, Reliable Knowledge Graphs](https://www.youtube.com/watch?v=VpFVAE3L1nk) from Feb 13, 2025\) with [Nico Gerold](https://x.com/nicolaygerold), temporal relationships are the next frontier for understanding data. While uncomfortable to confront, the concept of "truth" is often murky. One way of establishing ground truth is to find an observation that remains constant: that data point always was and always will be. But can you establish truth from a single observation?
...
- GitHub Repository: [https://github.com/trustgraph-ai/trustgraph](https://github.com/trustgraph-ai/trustgraph)
- Discord Community: [https://discord.gg/sQMwkRz5GX](https://discord.gg/sQMwkRz5GX)
- Website: [https://trustgraph.ai](https://trustgraph.ai)
